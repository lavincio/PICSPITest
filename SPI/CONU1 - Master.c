...
volatile looped = 1;		//if finihsed a loop
...
//SpiChnOpen(Device,SPI_OPEN_MSTEN|SPI_OPEN_MSSEN|SPI_OPEN_MODE8|SPI_OPEN_ON|SPI_OPEN_CKE_REV ,200);
SpiChnOpen(Device,SPI_OPEN_MSTEN|SPI_OPEN_MSSEN|SPI_OPEN_MODE8|SPI_OPEN_TBE_SR_EMPTY|SPI_OPEN_ON|SPI_OPEN_CKE_REV ,200);
